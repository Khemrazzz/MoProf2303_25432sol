<%@ Page Title="" Language="C#" MasterPageFile="~/stDashboard.Master" AutoEventWireup="true" CodeBehind="tutorAddCoursePage.aspx.cs" Inherits="MoProf2303_25432.tutorAddCoursePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <main>
        ...
        <div class="edit-profile-container">
            ...
            <asp:Label runat="server" for="fuppicture4" CssClass="form-label">Upload course picture</asp:Label>
            <asp:FileUpload ID="fuppicture4" runat="server" name="CoursePicture" CssClass="form-control" />
            <asp:RequiredFieldValidator ID="rfvfuppicture4" runat="server" ValidationGroup="vgtutor" Display="Dynamic" ControlToValidate="fuppicture4" SetFocusOnError="true" ErrorMessage="Course picture is mandatory" ForeColor="red"></asp:RequiredFieldValidator>


            <asp:Label runat="server" CssClass="form-label">Course Name</asp:Label>
            ...
            <asp:Label runat="server" CssClass="form-label">Category</asp:Label>
            ...
            <asp:Label runat="server" CssClass="form-label">Fees</asp:Label>
            ...
            <asp:Label runat="server" CssClass="form-label">Date</asp:Label>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <asp:Label runat="server" CssClass="form-label">Day</asp:Label>
                    ...
                    <br />
                    <asp:Label runat="server" CssClass="form-label">Time</asp:Label>
            ...
            <asp:Label runat="server" CssClass="form-label">Mode</asp:Label>
            ...
            <asp:Label runat="server" CssClass="form-label">Seats</asp:Label>
