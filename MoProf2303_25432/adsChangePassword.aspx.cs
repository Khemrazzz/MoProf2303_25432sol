...
{
    public partial class adsChangePassword : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else if (!IsPostBack)
                {
                    if (Session["Advertiser_Id"] != null)
                    {
                        ...
                        PasswordAdvertiserEdit(Advertiser_Id);
        ...
        private void PasswordAdvertiserEdit(string Advertiser_Id)
        {
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query = "SELECT COUNT(*) FROM Advertiser WHERE Advertiser_Id = @Advertiser_Id AND Password = @Password";
                ...
                query = "UPDATE Advertiser SET Password = @NewPassword WHERE Advertiser_Id = @Advertiser_Id";
                using (SqlCommand command = new SqlCommand(query, connection))
                {
